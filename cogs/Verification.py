...
class VerificationTicketSystem(commands.Cog):
    ...
    async def setup_verify(
        ...
        main_embed.add_field(
            name="ㅤ",
            value=(
                "**<a:originals_yellow:1422974161994649670> Example Here: "
                "[Click Me ](https://cdn.discordapp.com/attachments/1405225685596901526/1424429041028567110/ChatGPT_Image_Oct_1_2025_08_56_11_PM.png?ex=68e3ea6b&is=68e298eb&hm=a6e4352dbc7b4f9faf44041adab92379bdeff9de3d2df842bce42c33f8ed55b3&)**"
            ),
            inline=False
        )
        ...
        # Send embeds with persistent button
    ...
    async def verify_button(
        ...
        try:
            ...
            ticket_embed.add_field(
                ...
                value="[Click here to see an example](https://cdn.discordapp.com/attachments/1405225685596901526/1424429041028567110/ChatGPT_Image_Oct_1_2025_08_56_11_PM.png?ex=68e3ea6b&is=68e298eb&hm=a6e4352dbc7b4f9faf44041adab92379bdeff9de3d2df842bce42c33f8ed55b3&)",
                inline=False
            )
